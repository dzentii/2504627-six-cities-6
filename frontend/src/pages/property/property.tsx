...
const Property = (): JSX.Element | null => {
  ...
  const handleOfferImageError = (evt: SyntheticEvent<HTMLImageElement>) => {
    const imageElement = evt.currentTarget;
    imageElement.onerror = null;
    imageElement.src = '/img/apartment-01.jpg';
  };

  const handleAvatarImageError = (evt: SyntheticEvent<HTMLImageElement>) => {
    const imageElement = evt.currentTarget;
    imageElement.onerror = null;
    imageElement.src = '/img/avatar.svg';
  };
